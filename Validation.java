...
public class Validation {
	...
	public String userPhone(String phoneno) {
		if (phoneno.startsWith("6") || phoneno.startsWith("7") || phoneno.startsWith("8") || phoneno.startsWith("9")) {
			return "Registration of phone number is success";
		} else if (phoneno.length() == 10 && phoneno.isEmpty()) {
			return "length should be 10 character and not empty";
		}
